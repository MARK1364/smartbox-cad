import{aL as B,aK as A,i as P,c as R,j as y,R as O,r as w,a as C,aM as T,ad as D,ag as $,aN as I,w as U}from"./report-data-normalizer-oXnivjUY.js";import{M as H}from"./ModuleSourceBar-CQkaGJ2k.js";const K={W1100_ST9_18:{price:92,unit:"m2",name:"Biały Alpejski 18mm"},H1110_ST9_18:{price:118,unit:"m2",name:"Sosna Sealand 18mm"},H1113_ST10_18:{price:124,unit:"m2",name:"Dąb Kansas brązowy 18mm"},H1115_ST12_18:{price:118,unit:"m2",name:"Bamenda szarobeżowa 18mm"},H1115_ST9_18:{price:118,unit:"m2",name:"Bamenda szarobeżowa 18mm (ST9)"},H1122_ST22_18:{price:118,unit:"m2",name:"Whitewood 18mm"},H1123_ST22_18:{price:118,unit:"m2",name:"Graphitewood 18mm"},H1137_ST12_18:{price:129,unit:"m2",name:"Dąb Sorano czarnobrązowy 18mm"},H1145_ST10_18:{price:118,unit:"m2",name:"Dąb Bardolino naturalny 18mm"},H1146_ST10_18:{price:118,unit:"m2",name:"Dąb Bardolino szary 18mm"},H1150_ST10_18:{price:118,unit:"m2",name:"Dąb Arizona szary 18mm"},W1100_ST9_10:{price:31,unit:"m2",name:"Biały Alpejski 10mm"},H1110_ST9_10:{price:31,unit:"m2",name:"Sosna Sealand 10mm"},H1113_ST10_10:{price:31,unit:"m2",name:"Dąb Kansas brązowy 10mm"},H1115_ST12_10:{price:31,unit:"m2",name:"Bamenda szarobeżowa 10mm"},H1115_ST9_10:{price:31,unit:"m2",name:"Bamenda szarobeżowa 10mm (ST9)"},H1122_ST22_10:{price:31,unit:"m2",name:"Whitewood 10mm"},H1123_ST22_10:{price:31,unit:"m2",name:"Graphitewood 10mm"},H1137_ST12_10:{price:31,unit:"m2",name:"Dąb Sorano czarnobrązowy 10mm"},H1145_ST10_10:{price:31,unit:"m2",name:"Dąb Bardolino naturalny 10mm"},H1146_ST10_10:{price:31,unit:"m2",name:"Dąb Bardolino szary 10mm"},H1150_ST10_10:{price:31,unit:"m2",name:"Dąb Arizona szary 10mm"},MDF_SUROWY_18:{price:45,unit:"m2",name:"MDF Surowy 18mm"},PLYTY_18:{price:65,unit:"m2",name:"Płyta Laminowana 18mm"},W1100_ST9_16:{price:82,unit:"m2",name:"Biały Alpejski 16mm"},PLYTY_16:{price:60,unit:"m2",name:"Płyta Laminowana 16mm"},HDF_3:{price:35,unit:"m2",name:"HDF Surowy 3mm (Plecy)"},HDF_BIALY_3:{price:35,unit:"m2",name:"HDF Biały 3mm"},HDF_CZARNY_3:{price:32,unit:"m2",name:"HDF Czarny 3mm"},LACOBEL_BIALY:{price:120,unit:"m2",name:"Szkło Lacobel Biały"},LACOBEL_CZARNY:{price:120,unit:"m2",name:"Szkło Lacobel Czarny"},SZKLO_MATOWE:{price:120,unit:"m2",name:"Szkło Matowe"},SZKLO_DYMNE:{price:120,unit:"m2",name:"Szkło Dymne"},LUSTRO_SREBRNE_4:{price:140,unit:"m2",name:"Lustro Srebrne 4mm"}},j={EDGE_BANDING_08x22:{price:3.5,unit:"mb",name:"Oklejanie obrzeżem 0.8x22mm"},okleinowanie_2x22:{price:5.5,unit:"mb",name:"Oklejanie obrzeżem 2x22mm"},okleinowanie_2x50:{price:8,unit:"mb",name:"Oklejanie obrzeżem 2x50mm"},CIECIE_M2:{price:15,unit:"m2",name:"Cięcie płyt na wymiar"},WIERCENIE_CNC_SZT:{price:1.5,unit:"szt",name:"Odwiert CNC (cena za sztukę)"}},Y={HINGE_BLUM_71B3550:{price:12,unit:"szt",name:"Zawias Blum Clip Top 110st (zintegrowany hamulec)"},HINGE_BLUM_71T3550:{price:6,unit:"szt",name:"Zawias Blum Clip Top 110st (bez hamulca)"},BLUM_71T3550:{price:6,unit:"szt",name:"Zawias Blum Clip Top 110st (bez hamulca)"},HINGE_BLUM_713550:{price:6,unit:"szt",name:"Zawias Blum Clip Top 110st (bez hamulca)"},HINGE_BLUM_71B3750:{price:14,unit:"szt",name:"Zawias Blum Clip Top 110st wpuszczany (z hamulcem)"},HINGE_BLUM_71T3750:{price:13,unit:"szt",name:"Zawias Blum Clip Top 110st wpuszczany (bez hamulca)"},HINGE_GTV_3D:{price:8,unit:"szt",name:"Zawias GTV Hydrauliczny 110st 3D (z hamulcem)"},HINGE_GTV_STD:{price:5,unit:"szt",name:"Zawias GTV Standardowy 110st (bez hamulca)"},HINGE_HETTICH_8645I:{price:13.5,unit:"szt",name:"Zawias Hettich Sensys 8645i 110st (z hamulcem)"},HINGE_HETTICH_8645:{price:12,unit:"szt",name:"Zawias Hettich Sensys 8645 110st (bez hamulca)"},PODPORKA_POLKI:{price:.5,unit:"szt",name:"Podpórka pod półkę metalowa"},ROZETA_FI25:{price:8.5,unit:"szt",name:"Rozeta rury fi25 uchwyt"},BLUM_ANTARO_M_300:{price:350,unit:"kpl",name:"Szuflada Blum Tandembox Antaro M 300mm"},BLUM_ANTARO_M_350:{price:350,unit:"kpl",name:"Szuflada Blum Tandembox Antaro M 350mm"},BLUM_ANTARO_M_400:{price:350,unit:"kpl",name:"Szuflada Blum Tandembox Antaro M 400mm"},BLUM_ANTARO_M_450:{price:350,unit:"kpl",name:"Szuflada Blum Tandembox Antaro M 450mm"},BLUM_ANTARO_M_500:{price:350,unit:"kpl",name:"Szuflada Blum Tandembox Antaro M 500mm"},BLUM_ANTARO_M_550:{price:350,unit:"kpl",name:"Szuflada Blum Tandembox Antaro M 550mm"},BLUM_ANTARO_M_600:{price:350,unit:"kpl",name:"Szuflada Blum Tandembox Antaro M 600mm"},BLUM_ANTARO_N_270:{price:310,unit:"kpl",name:"Szuflada Blum Tandembox Antaro N 270mm"},BLUM_ANTARO_N_300:{price:310,unit:"kpl",name:"Szuflada Blum Tandembox Antaro N 300mm"},BLUM_ANTARO_N_350:{price:310,unit:"kpl",name:"Szuflada Blum Tandembox Antaro N 350mm"},BLUM_ANTARO_N_400:{price:310,unit:"kpl",name:"Szuflada Blum Tandembox Antaro N 400mm"},BLUM_ANTARO_N_450:{price:310,unit:"kpl",name:"Szuflada Blum Tandembox Antaro N 450mm"},BLUM_ANTARO_N_500:{price:310,unit:"kpl",name:"Szuflada Blum Tandembox Antaro N 500mm"}},F={prices_materials:K,prices_services:j,prices_hardware:Y};class S{prices;smartPanel;materialNameCache={};constructor(){this.prices=F,this.smartPanel=B,this._buildMaterialNameCache()}_buildMaterialNameCache(){try{const t=this.smartPanel?.materials_database||{};for(const e of Object.values(t))if(e?.items)for(const[n,i]of Object.entries(e.items))i?.name&&(this.materialNameCache[n]=String(i.name))}catch{this.materialNameCache={}}}resolveMaterialName(t){if(!t)return"Płyta";if(this.materialNameCache[t])return this.materialNameCache[t];const e=this.prices?.prices_materials||{};return e[t]?.name?e[t].name:t.replace(/_/g," ")}getMaterialPricePerM2(t){const e=this.prices?.prices_materials||{};if(e[t]!==void 0){const i=e[t];return Number(typeof i=="object"?i.price:i)}const n=t.trim().toUpperCase().replace(/[\s\-]+/g,"_");for(const[i,a]of Object.entries(e))if(i.trim().toUpperCase().replace(/[\s\-]+/g,"_")===n)return Number(typeof a=="object"?a.price:a);return null}getEdgeBandPricePerM(t){const e=this.smartPanel?.edge_banding_types||{},n=this.prices?.prices_services||{};let i="";if(e[t]?.prices_services&&(i=e[t].prices_services),i&&n[i]!==void 0){const l=n[i];return Number(typeof l=="object"?l.price:l)}const a={"0.008X0.022":"EDGE_BANDING_08x22","0.008x0.022":"EDGE_BANDING_08x22","0.8X22":"EDGE_BANDING_08x22","ABS_0.8X22":"EDGE_BANDING_08x22","ABS_0.8x22":"EDGE_BANDING_08x22",ABS_1X22:"EDGE_BANDING_08x22",ABS_1x22:"EDGE_BANDING_08x22","ABS_1.0X22":"EDGE_BANDING_08x22","ABS_1.0x22":"EDGE_BANDING_08x22","2.0X22":"okleinowanie_2x22","2.0x22":"okleinowanie_2x22","2X22":"okleinowanie_2x22",ABS_2X22:"okleinowanie_2x22","ABS_2.0X22":"okleinowanie_2x22","2.0X50":"okleinowanie_2x50","2.0x50":"okleinowanie_2x50","2X50":"okleinowanie_2x50","ABS_0.8X43":"okleinowanie_2x50","ABS_0.8x43":"okleinowanie_2x50"},r=t.trim().toUpperCase();if(a[r]&&n[a[r]]!==void 0){const l=n[a[r]];return Number(typeof l=="object"?l.price:l)}return 3.5}calculatePartPricing(t){const e=t.length_mm/1e3,n=t.width_mm/1e3,i=Math.round(e*n*1e3)/1e3,a=this.getMaterialPricePerM2(t.material),r=this.resolveMaterialName(t.material);let l="BRAK CENY";a!==null&&(l=Math.round(i*a*100)/100);let c=0,p=0,b=!1;const m=t.edge_config||{},h=["+X","-X","+Y","-Y"];for(const s of h){const g=m[s];if(g&&g.active){const _=(s==="+X"||s==="-X"?t.is_x_longer:!t.is_x_longer)?e:n;c+=_;const f=this.getEdgeBandPricePerM(g.type_id||"0.008x0.022");f===null?b=!0:b||(p+=_*f)}}const u=Math.round(c*100)/100,o=b?"BRAK CENY":Math.round(p*100)/100;let k="BRAK CENY";return l!=="BRAK CENY"&&o!=="BRAK CENY"&&(k=Math.round((l+o)*100)/100),{part_id:t.part_id,role:t.role,material_id:t.material,material_name:r,thickness_mm:t.thickness_mm,length_mm:t.length_mm,width_mm:t.width_mm,area_m2:i,price_per_m2:a!==null?a:"BRAK CENY",material_cost:l,edge_length_mb:u,edge_cost:o,total_netto_pln:k,edge_config:t.edge_config,is_x_longer:t.is_x_longer,furniture_name:t.furniture_name,qty:t.qty||1}}calculateAccessoryPricing(t){const e=this.prices?.prices_hardware||{};let n=e[t.library_id];if(n===void 0){const r=t.library_id.trim().toUpperCase();for(const[l,c]of Object.entries(e))if(l.trim().toUpperCase()===r){n=c;break}}let i="BRAK CENY",a="BRAK CENY";if(n!==void 0){const r=Number(typeof n=="object"?n.price:n);i=r,a=Math.round(r*t.qty*100)/100}return{id:t.id,name:t.name,role:t.role,library_id:t.library_id,qty:t.qty,unit_price_pln:i,total_price_pln:a,furniture_name:t.furniture_name}}calculateGlobalSummary(t,e=[]){let n=0,i=0,a=0,r=0,l=!1;const c={};for(const s of t){const g=s.qty||1;n+=s.area_m2*g,a+=s.edge_length_mb*g,s.material_cost==="BRAK CENY"||s.edge_cost==="BRAK CENY"?l=!0:(i+=Number(s.material_cost)*g,r+=Number(s.edge_cost)*g),s.total_netto_pln!=="BRAK CENY"&&(c[s.furniture_name]=(c[s.furniture_name]||0)+Number(s.total_netto_pln)*g)}let p=0,b=0,m=!1;for(const s of e)p+=s.qty,s.total_price_pln==="BRAK CENY"?m=!0:(b+=Number(s.total_price_pln),c[s.furniture_name]=(c[s.furniture_name]||0)+Number(s.total_price_pln));const h=l?"BRAK CENY":Math.round((i+r)*100)/100,u=m?"BRAK CENY":Math.round(b*100)/100;let o="BLAD W WYCENIE";h!=="BRAK CENY"&&u!=="BRAK CENY"&&(o=Math.round((h+u)*100)/100);const k=Object.entries(c).map(([s,g])=>({name:s,cost:Math.round(g*100)/100}));return{Liczba_elementow:t.reduce((s,g)=>s+(g.qty||1),0),Calkowite_powierzchnia_m2:Math.round(n*1e3)/1e3,Calkowite_cena_plyt_PLN:l?"BRAK CENY":Math.round(i*100)/100,Calkowite_dlugosc_obrzezy_mb:Math.round(a*100)/100,Calkowite_cena_obrzezy_PLN:l?"BRAK CENY":Math.round(r*100)/100,SUMA_PLYTY_PLN:h,Calkowite_liczba_akcesorii_szt:p,Calkowite_cena_akcesorii_PLN:u,SUMA_AKCESORIA_PLN:u,SUMA_CALKOWITA_PLN:o,furnituresBreakdown:k}}}class G{engine;constructor(t){this.engine=t||new S}getEdgeCode(t,e,n=!0){if(!t||typeof t!="object")return"0";let i,a;e==="length"?n?(i=t["+X"]||{},a=t["-X"]||{}):(i=t["+Y"]||{},a=t["-Y"]||{}):n?(i=t["+Y"]||{},a=t["-Y"]||{}):(i=t["+X"]||{},a=t["-X"]||{});const r=i.active===!0,l=a.active===!0,c=(r?1:0)+(l?1:0);return String(c)}formatThickness(t){return Math.abs(t-Math.round(t))<.05?`${Math.round(t)}mm`:`${t.toFixed(1)}mm`}generateMaterialCuttingTabsHtml(t,e="repMatTab"){const i=new Date().toISOString().slice(0,10),a={};for(const p of t){const b=`${p.material}_${p.thickness_mm}`;a[b]||(a[b]={material_id:p.material,thickness_mm:p.thickness_mm,panels:[]}),a[b].panels.push(p)}const r=Object.values(a).sort((p,b)=>{const m=this.engine.resolveMaterialName(p.material_id).toLowerCase(),h=this.engine.resolveMaterialName(b.material_id).toLowerCase();return m.localeCompare(h)||p.thickness_mm-b.thickness_mm});r.length===0&&r.push({material_id:"W1100_ST9_18",thickness_mm:18,panels:[]});let l="",c="";return r.forEach((p,b)=>{const m=this.engine.resolveMaterialName(p.material_id),h=this.formatThickness(p.thickness_mm),u=`Lista cięć - ${m} ${h}`,o=`${e}_${b}`,k=b===0?" active":"";l+=`<button class="material-tablinks${k}" onclick="openMaterialCutTab(event, '${o}')">${u}</button>`;const s=[...p.panels].sort((_,f)=>(_.role||"").localeCompare(f.role||"")||f.length_mm-_.length_mm||f.width_mm-_.width_mm),g=Object.values(A.aggregateContractRows(s)),v=Math.max(1,Math.ceil(g.length/30));c+=`<div id="${o}" class="material-tabcontent${k}">`;for(let _=0;_<v;_++){const f=_*30,z=g.slice(f,f+30);c+=`
                <div class="cut-sheet">
                    ...
                    <table class="cut-header-table">
                        <tbody>
                            ...
                            <tr><th>Data</th><td>${i}</td><th>Strona</th><td>${_+1}/${v}</td></tr>
                        </tbody>
                    </table>
                    ...
                    <table class="cutting-table-a4">
                        ...
                        <tbody>`;for(let N=0;N<30;N++)if(N<z.length){const x=z[N],L=N+1,E=this.getEdgeCode(x.edge_config,"length",x.is_x_longer),M=this.getEdgeCode(x.edge_config,"width",x.is_x_longer);c+=`
                            <tr>
                                <td>${L}</td>
                ...
                </div>`}c+="</div>"}),{buttonsHtml:l,contentHtml:c}}generateFullProjectReport(t,e,n,i=[]){const a=new Date().toLocaleString("pl-PL"),r=n.map(o=>({part_id:o.part_id,role:o.role,material:o.material_id,thickness_mm:o.thickness_mm,length_mm:o.length_mm,width_mm:o.width_mm,edge_config:o.edge_config,is_x_longer:o.is_x_longer,furniture_name:o.furniture_name,qty:o.qty||1})),{buttonsHtml:l,contentHtml:c}=this.generateMaterialCuttingTabsHtml(r,"repMatTab");let p="";for(const o of e.furnituresBreakdown)p+=`<tr><td style="text-align:left; font-weight:600; padding:8px 12px; border:1px solid #ddd;">${o.name}</td><td style="text-align:right; padding:8px 12px; border:1px solid #ddd; font-weight:bold; color:#1976d2;">${o.cost.toFixed(2)} PLN</td></tr>`;let b="",m=1;for(const o of n)b+=`
            <tr>
                ...
                <td style="padding:4px; border:1px solid #ddd; text-align:center;">${o.thickness_mm} mm</td>
    ...
    <div class="container">
        ...
        <div class="summary-cards">
            ...
            <div class="card">
                ...
                <div class="value" style="color:#7c3aed;">${typeof e.SUMA_AKCESORIA_PLN=="number"?e.SUMA_AKCESORIA_PLN.toFixed(2)+" PLN":e.SUMA_AKCESORIA_PLN}</div>
            </div>
            <div class="card">
                <div class="title">Płyty i Obrzeża</div>
                <div class="value">${typeof e.SUMA_PLYTY_PLN=="number"?e.SUMA_PLYTY_PLN.toFixed(2)+" PLN":e.SUMA_PLYTY_PLN}</div>
            </div>
            <div class="card">
            ...
            <div class="card">
                ...
                <div class="value">${e.Liczba_elementow} / ${e.Calkowite_liczba_akcesorii_szt} szt.</div>
            </div>
        </div>
            ...
            <table class="general-table">
                ...
                <tfoot>
                    <tr style="background:#e3f2fd; font-weight:bold;">
                        ...
                        <td style="padding:10px;">${e.Calkowite_powierzchnia_m2.toFixed(3)} m²</td>
                        <td style="padding:10px;">${typeof e.Calkowite_cena_plyt_PLN=="number"?e.Calkowite_cena_plyt_PLN.toFixed(2)+" PLN":e.Calkowite_cena_plyt_PLN}</td>
                        <td style="padding:10px;">${e.Calkowite_dlugosc_obrzezy_mb.toFixed(2)} mb</td>
                        <td style="padding:10px;">${typeof e.Calkowite_cena_obrzezy_PLN=="number"?e.Calkowite_cena_obrzezy_PLN.toFixed(2)+" PLN":e.Calkowite_cena_obrzezy_PLN}</td>
                        <td style="padding:10px; color:#1565c0; font-size:14px; font-weight:bold;">${typeof e.SUMA_PLYTY_PLN=="number"?e.SUMA_PLYTY_PLN.toFixed(2)+" PLN":e.SUMA_PLYTY_PLN}</td>
                    </tr>
                </tfoot>
            </table>
        </div>
            ...
            <table class="general-table">
                ...
                <tfoot>
                    <tr style="background:#e3f2fd; font-weight:bold;">
                        ...
                        <td style="padding:10px; font-size:12px;">${e.Calkowite_liczba_akcesorii_szt} szt.</td>
                        <td style="padding:10px;">—</td>
                        <td style="padding:10px; color:#1565c0; font-size:14px; font-weight:bold;">${typeof e.SUMA_AKCESORIA_PLN=="number"?e.SUMA_AKCESORIA_PLN.toFixed(2)+" PLN":e.SUMA_AKCESORIA_PLN}</td>
                        <td style="padding:10px;">—</td>
                    </tr>
                </tfoot>
            </table>
...
</html>`}generateCsv(t){const e=A.aggregateContractRows(t),n=[];n.push("\uFEFFLP;Dlugosc;Okleinowanie_Dlugosci;Szerokosc;Okleinowanie_Szerokosci;Szt;Rola;Material;Grubosc");let i=1;for(const a of Object.values(e)){const r=this.getEdgeCode(a.edge_config,"length",a.is_x_longer),l=this.getEdgeCode(a.edge_config,"width",a.is_x_longer),c=this.engine.resolveMaterialName(a.material);n.push([i++,Math.round(a.length_mm),r,Math.round(a.width_mm),l,a.qty,`"${a.role.replace(/"/g,'""')}"`,`"${c.replace(/"/g,'""')}"`,a.thickness_mm].join(";"))}return n.join(`
`)}downloadFile(t,e,n="text/html;charset=utf-8"){const i=new Blob([t],{type:n}),a=URL.createObjectURL(i),r=document.createElement("a");r.href=a,r.download=e,document.body.appendChild(r),r.click(),document.body.removeChild(r),URL.revokeObjectURL(a)}openHtmlInNewTab(t){const e=new Blob([t],{type:"text/html;charset=utf-8"}),n=URL.createObjectURL(e);window.open(n,"_blank")||alert("Wyskakujące okno zostało zablokowane przez przeglądarkę.")}}P("report");function W(d){const t=new S,e=new G(t),n=d.panels.map(l=>t.calculatePartPricing(l)),i=(d.accessories||[]).map(l=>t.calculateAccessoryPricing(l)),a=t.calculateGlobalSummary(n,i),r=d.scope?.type==="PROJECT"||!d.scope?.name?d.meta?.originLabel||"Projekt CAD":`Wycena: ${d.scope.name}`;return e.generateFullProjectReport(r,a,n,i)}function Z(d,t){const e=JSON.parse(d),n=e.panels?{meta:{module:"report",sourceId:"json",loadedAt:new Date().toISOString(),originLabel:`JSON · ${t}`},scope:e.scope||{type:"PROJECT",id:"ALL",name:t},panels:e.panels,accessories:e.accessories||[],furnitures:e.furnitures||[],containers:e.containers||[]}:e;if(!n.panels)throw new Error("JSON musi zawierać tablicę panels");return n}function q(){const[d,t]=w.useState(()=>C("report")),[e,n]=w.useState(d?null:"Brak danych. Otwórz raport z drzewa CAD (PPM) albo wczytaj JSON."),[i,a]=w.useState(null),r=w.useCallback(()=>{const m=C("report");m?.panels&&(t(m),n(null),a(m.meta?.loadedAt?`Odświeżono ${new Date(m.meta.loadedAt).toLocaleTimeString("pl-PL")}`:"Odświeżono"))},[]),l=w.useCallback(()=>{const m=d?.scope;if(!m){a("Brak zakresu — otwórz raport ponownie z CAD.");return}a("Pobieram z CAD…"),T("report",m),window.setTimeout(()=>r(),400)},[d?.scope,r]);w.useEffect(()=>{const m=u=>{u.key===I.report&&u.newValue&&r()};window.addEventListener("storage",m);let h=null;try{h=new BroadcastChannel(D),h.onmessage=u=>{const o=u.data;o?.type===$&&o.module==="report"&&r()}}catch{}return()=>{window.removeEventListener("storage",m);try{h?.close()}catch{}}},[r]),w.useEffect(()=>{const m=()=>{d?.meta?.sourceId!=="cad"&&d?.meta?.sourceId!=="session"||d?.scope&&T("report",d.scope)};return window.addEventListener("focus",m),()=>window.removeEventListener("focus",m)},[d?.meta?.sourceId,d?.scope]);const c=w.useMemo(()=>{if(!d?.panels)return null;try{return W(d)}catch{return null}},[d]),p=(m,h)=>{try{const u=Z(m,h);U("report",u),t(u),n(null),a(null)}catch(u){n(u?.message||"Niepoprawny JSON raportu")}},b=!!d?.scope&&(d.meta?.sourceId==="cad"||d.meta?.sourceId==="session");return y.jsxs("div",{style:{display:"flex",flexDirection:"column",height:"100%"},children:[y.jsx(H,{module:"report",title:"Raport",originLabel:d?.meta.originLabel||d?.scope.name,onLoadJson:p,onRefreshFromCad:b?l:void 0,statusHint:i||void 0}),e&&!d&&y.jsx("div",{style:{padding:24,color:"#fbbf24"},children:e}),d&&!c&&y.jsx("div",{style:{padding:24,color:"#f87171"},children:"Nie udało się wygenerować raportu HTML."}),c&&y.jsx("iframe",{title:"Raport projektu",srcDoc:c,style:{flex:1,minHeight:0,width:"100%",border:"none",background:"#f4f7f9"}})]})}R.createRoot(document.getElementById("report-root")).render(y.jsx(O.StrictMode,{children:y.jsx(q,{})}));
